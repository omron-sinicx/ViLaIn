...
(:goal (and (on orange_disk1 peg3) (on pink_disk1 orange_disk1) (on blue_disk1 pink_disk1) (on green_disk2 blue_disk1) (on green_disk1 green_disk2)))
)