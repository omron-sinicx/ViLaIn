...
(:init
        ...
        (smaller blue_disk1 green_disk2)
...
(:goal (and (on blue_disk1 peg3) (on purple_disk1 blue_disk1) (on orange_disk1 purple_disk1) (on green_disk2 orange_disk1) (on yellow_disk1 green_disk2) (on green_disk1 yellow_disk1)))
)