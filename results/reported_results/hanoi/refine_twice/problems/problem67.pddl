...
(:init
        ...
        (on orange_disk1 orange_disk3)
        (on orange_disk3 purple_disk1)
...
(:goal (and (on pink_disk2 peg3) (on blue_disk2 pink_disk2) (on purple_disk1 blue_disk2) (on orange_disk3 purple_disk1) (on orange_disk1 orange_disk3) (on green_disk2 orange_disk1) (on yellow_disk1 green_disk2) (on pink_disk1 yellow_disk1) (on green_disk1 pink_disk1) (on blue_disk1 green_disk1)))
)