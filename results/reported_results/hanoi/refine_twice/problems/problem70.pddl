...
(:goal (and (on blue_disk1 peg3) (on green_disk1 blue_disk1) (on pink_disk1 green_disk1) (on yellow_disk1 pink_disk1) (on green_disk2 yellow_disk1) (on orange_disk1 green_disk2) (on purple_disk1 orange_disk1) (on blue_disk2 purple_disk1) (on pink_disk2 blue_disk2))))
)