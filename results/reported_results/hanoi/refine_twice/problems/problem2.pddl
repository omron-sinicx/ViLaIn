...
(:init
        ...
        (smaller pink_disk1 green_disk2)
...
(:goal (and (on pink_disk1 peg3) (on orange_disk1 pink_disk1) (on blue_disk1 orange_disk1) (on green_disk1 blue_disk1) (on green_disk2 green_disk1)))
)