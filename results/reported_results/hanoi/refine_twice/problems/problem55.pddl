...
(:init
        ...
        (smaller blue_disk3 blue_disk1)
        (smaller blue_disk3 green_disk1)
        (smaller blue_disk3 orange_disk1)
        (smaller blue_disk3 yellow_disk1)
        (smaller blue_disk3 orange_disk2)
        (smaller blue_disk3 purple_disk1)
