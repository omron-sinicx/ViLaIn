...
(:init
        ...
        (smaller blue_disk1 yellow_disk3)
        (smaller blue_disk1 orange_disk1)
        (smaller blue_disk1 pink_disk1)
        (smaller yellow_disk1 yellow_disk2)
        (smaller yellow_disk1 yellow_disk3)
        (smaller yellow_disk1 orange_disk1)
        (smaller yellow_disk1 pink_disk1)
        (smaller yellow_disk2 yellow_disk3)
        (smaller yellow_disk2 orange_disk1)
        (smaller yellow_disk2 pink_disk1)
        (smaller yellow_disk3 orange_disk1)
        (smaller yellow_disk3 pink_disk1)
